...
var _UIElement = __webpack_require__(2);
...
module.exports = "<div class=\"ui-element-container\">\n\n  <!-- Textbox input -->\n  <div v-if=\"taxonomy.type === 'textbox'\" class=\"ui-element textbox\">\n    <input type=\"text\" v-model=\"value\" />\n  </div>\n\n  <!-- Button -->\n  <div v-if=\"taxonomy.type === 'button'\" class=\"ui-element button\">\n    <button @click=\"taxonomy.bind.click\">{{ taxonomy.name }}</button>\n  </div>\n\n  <!-- Slider (range) input -->\n  <div v-if=\"taxonomy.type === 'slider'\" class=\"ui-element slider\">\n    <input type=\"number\" min=\"1\" max=\"10\" v-model=\"value\" />\n  </div>\n\n</div>\n";

/***/ }),
/* 5 */
/***/ (function(module, exports) {

module.exports = "<div class=\"ifer-engine\">\n  <ui-element v-for=\"(element, key) in elements\" :key=\"key\" :taxonomy=\"element\" />\n</div>\n";
